...
var urlBase = "http://192.168.2.80:3000/api";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.listings.findById() instead.
        "prototype$__findById__listings": {
          url: urlBase + "/users/:id/listings/:fk",
          method: "GET",
        },

        // INTERNAL. Use User.listings.destroyById() instead.
        "prototype$__destroyById__listings": {
          url: urlBase + "/users/:id/listings/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use User.listings.updateById() instead.
        ...
        // INTERNAL. Use User.listings() instead.
        "prototype$__get__listings": {
          url: urlBase + "/users/:id/listings",
          method: "GET",
          isArray: true,
        },

        // INTERNAL. Use User.listings.create() instead.
        "prototype$__create__listings": {
          url: urlBase + "/users/:id/listings",
          method: "POST",
        },

        // INTERNAL. Use User.listings.destroyAll() instead.
        "prototype$__delete__listings": {
          url: urlBase + "/users/:id/listings",
          method: "DELETE",
        },

        // INTERNAL. Use User.listings.count() instead.
        "prototype$__count__listings": {
          url: urlBase + "/users/:id/listings/count",
          method: "GET",
        },
        ...
        // INTERNAL. Use Listing.user() instead.
        "::get::Listing::user": {
          url: urlBase + "/Listings/:id/user",
          method: "GET",
        },
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.listings
     * @object
     * @description
     *
     * The object `User.listings` groups methods
     * manipulating `Listing` instances related to `User`.
     *
     * Use {@link lbServices.User#listings} to query
     * all related instances.
     */
        ...
        R.listings = function() {
          ...
          var action = TargetResource["::get::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#count
         * @methodOf lbServices.User.listings
         *
         * @description
         *
         * Counts listings of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.listings.count = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::count::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#create
         * @methodOf lbServices.User.listings
         *
         * @description
         *
        ...
        R.listings.create = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::create::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#destroyAll
         * @methodOf lbServices.User.listings
         *
         * @description
         *
        ...
        R.listings.destroyAll = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::delete::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#destroyById
         * @methodOf lbServices.User.listings
         *
         * @description
         *
        ...
        R.listings.destroyById = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::destroyById::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#findById
         * @methodOf lbServices.User.listings
         *
         * @description
         *
        ...
        R.listings.findById = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::findById::user::listings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.listings#updateById
         * @methodOf lbServices.User.listings
         *
         * @description
         *
        ...
        R.listings.updateById = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::updateById::user::listings"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Listing.comments.findById() instead.
        "prototype$__findById__comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "GET",
        },

        // INTERNAL. Use Listing.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.comments.updateById() instead.
        "prototype$__updateById__comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "PUT",
        },

        // INTERNAL. Use Listing.intParties.findById() instead.
        "prototype$__findById__intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "GET",
        },

        // INTERNAL. Use Listing.intParties.destroyById() instead.
        "prototype$__destroyById__intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.intParties.updateById() instead.
        "prototype$__updateById__intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "PUT",
        },

        // INTERNAL. Use Listing.comments() instead.
        "prototype$__get__comments": {
          url: urlBase + "/Listings/:id/comments",
          method: "GET",
          isArray: true,
        },

        // INTERNAL. Use Listing.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/Listings/:id/comments",
          method: "POST",
        },

        // INTERNAL. Use Listing.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/Listings/:id/comments",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/Listings/:id/comments/count",
          method: "GET",
        },

        // INTERNAL. Use Listing.intParties() instead.
        "prototype$__get__intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "GET",
          isArray: true,
        },

        // INTERNAL. Use Listing.intParties.create() instead.
        "prototype$__create__intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "POST",
        },

        // INTERNAL. Use Listing.intParties.destroyAll() instead.
        "prototype$__delete__intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.intParties.count() instead.
        "prototype$__count__intParties": {
          url: urlBase + "/Listings/:id/intParties/count",
          method: "GET",
        },
        ...
        // INTERNAL. Use User.listings.findById() instead.
        "::findById::user::listings": {
          url: urlBase + "/users/:id/listings/:fk",
          method: "GET",
        },

        // INTERNAL. Use User.listings.destroyById() instead.
        "::destroyById::user::listings": {
          url: urlBase + "/users/:id/listings/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use User.listings.updateById() instead.
        "::updateById::user::listings": {
          url: urlBase + "/users/:id/listings/:fk",
          method: "PUT",
        },
        ...
        // INTERNAL. Use ListingComment.listing() instead.
        "::get::ListingComment::listing": {
          url: urlBase + "/ListingComments/:id/listing",
          method: "GET",
        },
      }
    );
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::Listing::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Listing.comments
     * @object
     * @description
     *
     * The object `Listing.comments` groups methods
     * manipulating `ListingComment` instances related to `Listing`.
     *
     * Use {@link lbServices.Listing#comments} to query
     * all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `ListingComment` object.)
         * </em>
         */
        R.comments = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::get::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#count
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
         * Counts comments of Listing.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::count::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#create
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::create::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#destroyAll
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::delete::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#destroyById
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::destroyById::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#findById
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::findById::Listing::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.comments#updateById
         * @methodOf lbServices.Listing.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("ListingComment");
          var action = TargetResource["::updateById::Listing::comments"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Listing.intParties
     * @object
     * @description
     *
     * The object `Listing.intParties` groups methods
     * manipulating `ListingIntParty` instances related to `Listing`.
     *
     * Use {@link lbServices.Listing#intParties} to query
     * all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `ListingIntParty` object.)
         * </em>
         */
        R.intParties = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::get::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#count
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Counts intParties of Listing.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.intParties.count = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::count::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#create
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Creates a new instance in intParties of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.intParties.create = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::create::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#destroyAll
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Deletes all intParties of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.intParties.destroyAll = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::delete::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#destroyById
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Delete a related item by id for intParties
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for intParties
         *
         * @param {Function(Object, Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         *  - `` – `{undefined=}` - 
         */
        R.intParties.destroyById = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::destroyById::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#findById
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Find a related item by id for intParties
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.intParties.findById = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::findById::Listing::intParties"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Listing.intParties#updateById
         * @methodOf lbServices.Listing.intParties
         *
         * @description
         *
         * Update a related item by id for intParties
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.intParties.updateById = function() {
          var TargetResource = $injector.get("ListingIntParty");
          var action = TargetResource["::updateById::Listing::intParties"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.ListingComment
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `ListingComment` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingComment#create
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         */
        "create": {
          url: urlBase + "/ListingComments",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#upsert
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingComment#exists
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/ListingComments/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#findById
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/ListingComments/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#find
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingComment#findOne
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/ListingComments/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#updateAll
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/ListingComments/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#deleteById
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingComment#count
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/ListingComments/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingComment#prototype$updateAttributes
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
        ...
        // INTERNAL. Use Listing.comments.findById() instead.
        "::findById::Listing::comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "GET",
        },

        // INTERNAL. Use Listing.comments.destroyById() instead.
        "::destroyById::Listing::comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.comments.updateById() instead.
        "::updateById::Listing::comments": {
          url: urlBase + "/Listings/:id/comments/:fk",
          method: "PUT",
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingComment#listing
         * @methodOf lbServices.ListingComment
         *
         * @description
         *
        ...
        R.listing = function() {
          var TargetResource = $injector.get("Listing");
          var action = TargetResource["::get::ListingComment::listing"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.ListingIntParty
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `ListingIntParty` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/ListingIntParties/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#create
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         */
        "create": {
          url: urlBase + "/ListingIntParties",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#upsert
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#exists
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/ListingIntParties/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#findById
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/ListingIntParties/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#find
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#findOne
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/ListingIntParties/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#updateAll
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/ListingIntParties/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#deleteById
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#count
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/ListingIntParties/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.ListingIntParty#prototype$updateAttributes
         * @methodOf lbServices.ListingIntParty
         *
         * @description
         *
        ...
        // INTERNAL. Use Listing.intParties.findById() instead.
        "::findById::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "GET",
        },

        // INTERNAL. Use Listing.intParties.destroyById() instead.
        "::destroyById::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.intParties.updateById() instead.
        "::updateById::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties/:fk",
          method: "PUT",
        },

        // INTERNAL. Use Listing.intParties() instead.
        "::get::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "GET",
          isArray: true,
        },
        ...
        // INTERNAL. Use Listing.intParties.create() instead.
        "::create::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "POST",
        },

        // INTERNAL. Use Listing.intParties.destroyAll() instead.
        "::delete::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties",
          method: "DELETE",
        },

        // INTERNAL. Use Listing.intParties.count() instead.
        "::count::Listing::intParties": {
          url: urlBase + "/Listings/:id/intParties/count",
          method: "GET",
        },
      }
